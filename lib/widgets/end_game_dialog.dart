                  ...
                  if (!_canContinue)
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: Text(t.menuLabel, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      ),
                    ),
                  ],
                ],
